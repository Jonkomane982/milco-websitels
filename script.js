...
const productsData = [
    {
        ...
        price: 120,
        category: 'Crafts',
        image: 'products/Assessories Baskets.jpg',
        isNew: true
    },
    {
        id: 'highland-milk',
        ...
        price: 25,
        category: 'Food',
        image: 'products/Highland milk.png',
        isNew: true
    },
    {
        id: 'jmm-wine',
    ...
    },
    {
        ...
        price: 850,
        category: 'Crafts',
        image: 'products/basotho blanket.jpg',
        isNew: false
    },
    {
        id: 'boriba-sauce',
        ...
        price: 45,
        category: 'Food',
        image: 'products/boriba source.jpg',
        isNew: false
    },
    {
        ...
        price: 200,
        category: 'Home',
        image: 'products/decoration grass Basin and Pot.jpg',
        isNew: false
    },
    {
        ...
        price: 150,
        category: 'Home',
        image: 'products/decoration grass Basin.jpg',
        isNew: false
    },
    {
        id: 'goat-milk',
    ...
    },
    {
        ...
        price: 180,
        category: 'Crafts',
        image: 'products/Mokorotlo hat.jpg',
        isNew: false
    },
    {
        id: 'other-products',
        ...
        price: 100,
        category: 'Food',
        image: 'products/other products.jpg',
        isNew: false
    },
    {
        id: 'pumpkin-juice',
        ...
        price: 40,
        category: 'Food',
        image: 'products/pumpkin juice.jpg',
        isNew: false
    },
    {
        id: 'tholoana-drink',
        ...
        price: 30,
        category: 'Food',
        image: 'products/tholoana Drink.jpg',
        isNew: false
    }
];
...
function updateCartCount() {
    ...
    // Toggle Checkout Link in Nav
    const navUl = document.querySelector('nav ul');
    if (navUl) {
        let checkoutLink = document.getElementById('nav-checkout');
        if (totalCount > 0 && !checkoutLink) {
            const li = document.createElement('li');
            li.id = 'nav-checkout';
            li.innerHTML = '<a href="checkout.html">Checkout</a>';
            navUl.appendChild(li);
        } else if (totalCount === 0 && checkoutLink) {
            checkoutLink.remove();
        }
    }
}
    ...
    return `
        <div class="card product-card fade-up" data-category="${product.category}">
            <div class="product-img-wrapper">
                ...
                <div class="quick-view-overlay" onclick="trackView('${product.id}'); window.location.href='shop.html?id=${product.id}'">
